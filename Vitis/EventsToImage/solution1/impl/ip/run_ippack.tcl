...
set Library     "hls"
set IPName      "eventsToImage"
set Version     "1.0"
set DisplayName "Eventstoimage"
set Revision    "2109061414"
...
set xo_kernel_name "eventsToImage"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/guill/Documents/Vitis_workspace/TFM/EventsToImage/solution1"
set debug_dir "C:/Users/guill/Documents/Vitis_workspace/TFM/EventsToImage/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {eventsToImage_img
...
## Variables
set Top "eventsToImage"
set TopNoPrefix "eventsToImage"
...
set Interfaces {
    s_axi_hls_ctrl {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_hls_ctrl"
        param_prefix "C_S_AXI_HLS_CTRL"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {{0x10 num_events W 0x0 "Data signal of num_events" {{0 32 num_events W 0 "Bit 31 to 0 of num_events"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_hls_ctrl input_r output_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 92775 II x}
