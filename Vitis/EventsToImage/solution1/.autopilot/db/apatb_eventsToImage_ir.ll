; ModuleID = 'C:/Users/guill/Documents/Vitis_workspace/TFM/EventsToImage/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_eventsToImage_ir(%"class.hls::stream"* %input, %"class.hls::stream"* %output, %struct.ap_uint* nocapture readonly %num_events) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_eventsToImage_hw(%"class.hls::stream"* %input_copy, %"class.hls::stream"* %output_copy, %struct.ap_uint* %num_events)
...
declare void @apatb_eventsToImage_hw(%"class.hls::stream"*, %"class.hls::stream"*, %struct.ap_uint*)

define void @eventsToImage_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %struct.ap_uint*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @eventsToImage_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %struct.ap_uint* %2)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @eventsToImage_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %struct.ap_uint*)
