...
extern "C" void eventsToImage(__cosim_sC__*, __cosim_sC__*, __cosim_s4__);
extern "C" void apatb_eventsToImage_hw(volatile void * __xlx_apatb_param_input, volatile void * __xlx_apatb_param_output, __cosim_s4__ __xlx_apatb_param_num_events) {
  ...
  // DUT call
  eventsToImage(__xlx_input_input_buffer, __xlx_output_input_buffer, __xlx_apatb_param_num_events);
