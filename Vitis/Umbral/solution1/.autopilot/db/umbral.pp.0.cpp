...
__attribute__((sdx_kernel("umbral", 0))) void umbral(stream_type &input, stream_type &output);
# 2 "Umbral/umbral.cpp" 2



__attribute__((sdx_kernel("umbral", 0))) void umbral(stream_type &input, stream_type &output) {
#pragma HLS TOP name=umbral
# 5 "Umbral/umbral.cpp"
...
#pragma HLS INTERFACE axis port=output
 ...
 type temp_in = input.read();
    type temp_out;


    VITIS_LOOP_14_1: for(int i = 0; i < 128*128; i++){
     wint_t pi = temp_in.data[i];
     wint_t po;
