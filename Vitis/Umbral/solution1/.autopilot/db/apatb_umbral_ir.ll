; ModuleID = 'C:/Users/guill/Documents/Vitis_workspace/TFM/Umbral/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_umbral_ir(%"class.hls::stream"* %input, %"class.hls::stream"* %output) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_umbral_hw(%"class.hls::stream"* %input_copy, %"class.hls::stream"* %output_copy)
...
declare void @apatb_umbral_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @umbral_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @umbral_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @umbral_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
