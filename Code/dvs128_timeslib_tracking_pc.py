'''
DVS128 Tracking using CAMShift for Ubuntu using DVSAbsLib library and Time Sections library.
...
while True:
    try:
        ...
        # Muestra la imagen final por pantalla
    ...
    # Cuando se interrumpe la ejecución del código, se cierra la conexión con el DVS
        ...
        print('\n\nGenerating graphs...\n')
        #timeslib.graphics(['get image', 'umbral', 'apertura', 'tracking', 'cam shift', 'show image'], title='Tiempos PC')
        print('\nReady! FINISHED\n')
        break
